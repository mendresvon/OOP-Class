...
### 1.1) 專案層文件固定路徑
以下文件統一放置於 `docs/`：
- `docs/project-overview.md`：專案總覽與模組邊界
- `docs/architecture.md`：架構分層與依賴方向
- `docs/data-format-kv-v1.md`：持久化格式與欄位規範
- `docs/security-authentication.md`：驗證與密碼安全策略
- `docs/testing-validation.md`：測試策略與驗證清單
...
- 若變更觸及架構/資料格式/安全主題，且 `docs/` 對應文件未更新，則檢查失敗。
